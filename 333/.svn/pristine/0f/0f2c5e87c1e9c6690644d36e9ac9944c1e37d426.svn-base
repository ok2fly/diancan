...
<div id="win10-login">
    ...
    <div id="win10-login-box">
        ...
        <form target="_self" method="post" action="${basePath}/console/frontLogin.action">
            <!--用户名-->
            <input type="text" name="user_name" placeholder="请输入登录名" class="login-username"> 
            <!--密码-->
            <input type="password" name="user_pwd" placeholder="请输入密码" class="login-password">
            <!--登陆按钮-->
