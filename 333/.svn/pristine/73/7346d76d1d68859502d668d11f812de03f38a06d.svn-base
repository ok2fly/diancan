...
CREATE TABLE `gcfd_auth` (
  ...
  PRIMARY KEY (`group_id`,`app_id`,`authority_id`)
...
#
# Structure for table "gcfd_authority"
#

CREATE TABLE `gcfd_authority` (
  `authority_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '权限ID',
  `authority_name` varchar(64) COLLATE utf8_bin DEFAULT NULL COMMENT '权限名称',
  PRIMARY KEY (`authority_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='权限表';

#
# Data for table "gcfd_authority"
#
