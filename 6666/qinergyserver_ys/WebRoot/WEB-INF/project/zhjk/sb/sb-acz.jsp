...
<html>
	...
	<div class="sb-main">
		<div class="sb-top bgff bor-radius">
			 ...
			 <div class="d5">	
			 	<div class="circle brgreen" onclick="getData(2)">
...
<script type="text/javascript">
	...
	//跳转页面
	var gourl = jumpPageUrl+"commens/zhjk/sb/acz.htm";;
 	$(function (){
	    		...
	    		if (data.resultcode=="USR000") {
	    			  if(data.data.length > 0 ){
	    				  if(data.data[0].dcchpEquLst ){
	    					  ...
	    					  /*表格数据 */
	    					  var html = '';
	    					  for(var i=0;i<data.data[0].dcchpEquLst.length;i++){
	    						  if(i < (currentPage*everyPageCount)){
		    						  var pcs = data.data[0].dcchpEquLst[i];
		    						  var sta ="";
		    						  var cls ="";
		    						  if(pcs.stat == 0){
		    							  sta = "离线";
	    					  ...
	    					  pageData = data.data[0].dcchpEquLst;
	    					  //算出总页数
		    				  countAll = 0 ;
