...
<div class="pt18">
	...
	<input type="hidden"  value="1" class="tjcs21">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="poptable">
		...
		<tr>
			<th>公司地址</th>
			<td colspan="3">
			<textarea    cols="3"  rows="3" placeholder="请输入公司地址" id="com_add"   onfocus="" class="poptextarea quinputcol tjcs3 requiredInp"></textarea>
			</td>
		</tr>
		<tr>
			<th>公司联系人</th>
		...
		<tr>
			<th>备注</th> 
			<td colspan="3">
			<textarea    cols="3"  rows="3" placeholder="请输入备注" id="remark"   onfocus="" class="poptextarea tjcs22"></textarea>
			</td>
	...
	<div class="tc popbutbox">
		...
		<input type="reset" class="popbut"  value="重置" class="cz" onclick="reset()" >
	</div>
</div>
...
function insert(){
	...
	console.log("param--"+param);
  	...
  	$.ajax({                
  		type : "post",
  		url: url+ "insertOrUpdateComInfoRol.htm",
  		data : param ,
  		dataType : "json",
  		success : function(data) {			
