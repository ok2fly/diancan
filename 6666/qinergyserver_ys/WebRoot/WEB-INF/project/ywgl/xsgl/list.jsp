		        ...
		        <div class="query">
			          <div class="fl">
				          	...
				          	<select class="fl quinput ml15"  id="type">
				          		...
				          		<option value="1">执行的</option>
				          		<option value="2">发布的</option>
			          ...
			          <div class="fr">
			          		 <a class="queryicon layer XJRW_QX"  data-url="<%=basePath%>/commens/ywgl/xsgl/add.htm" data-title="新增任务"  ><i class="add"></i>新建</a>
			          </div>
		          </div> 
	      	</div>
			            ...
			            <tbody id="datalist">
			             	<%-- <tr> 
					             <td>测试</td> 
				              	 ...
				              	 <td>2017-12-01</td> 
				              	 <td>
					              	 <a href='javascript:void(0);' onclick='shenhe(1,1)' >审核通过 </a> <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
					              	 <a href='javascript:void(0);' onclick='shenhe(1,2)'>审核不通过 </a> <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
					              	 <a  class='layer' data-url='<%=basePath%>commens/ywgl/xsgl/edit.htm?id=1' data-title='修改' data-width="700px" data-height="400px"  href='javascript:void(0);' >修改 </a> <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
					              	 <a  class='layer' data-url='<%=basePath%>commens/ywgl/xsgl/excute.htm?id=1' data-title='开始任务' data-width="700px" data-height="400px"  href='javascript:void(0);' >开始任务 </a> <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>
        				 ...
        				 for(var i = 0; i< data.data.length ; i++){
    		    				...
    		    				if( userId != undefined && userId != ""   ){
    		    					...
    		    					if(userId != d.appoint_id  && userId != d.task_execute_id && userId != d.task_check_id  ){
    		    						layerA = "<a  class='' data-url='<%=basePath%>commens/ywgl/xsgl/excuteQuery.htm?id="+d.id+"&routeId="+d.trnId+"' data-title='查看' onclick='chakanrenwu(this)' data-width='700px' data-height='500px'  href='javascript:void(0);' >查看</a>    " ;
    		    					}else{
    		    						//2.如果是当前用户的数据，判断状态是创建的、执行的、审核的或者多个的
    		    						//定义一个任务相关与人的状态的数组
    		    						var taskPersonStas = [];
    		    						...
    		    						if(d.task_sta == 1 ){//未指派
    	    		    					if($.inArray(2, taskPersonStas) > -1){
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a  class='layer ZPRW_QX' data-url='<%=basePath%>commens/ywgl/xsgl/appoint.htm?id="+d.id+"' data-title='任务指派' data-width='500px' data-height='300px'  href='javascript:void(0);' >指派 </a> " ;
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a  class='layer XGRW_QX' data-url='<%=basePath%>commens/ywgl/xsgl/edit.htm?id="+d.id+"' data-title='修改' data-width='700px' data-height='400px'  href='javascript:void(0);' >修改 </a> ";
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a class='SCRW_QX' href='javascript:void(0);' onclick='del("+d.id+")'>删除</a> " ;
    	    		    					}
    	    		    				}else if(d.task_sta == 2 ){//未开始
    	    		    					if($.inArray(1, taskPersonStas) > -1){
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a class='KSRW_QX' href='javascript:void(0);' onclick='kaishi("+d.id+","+d.trnId+")' >开始任务</a>  " ;
    	    		    					}
    	    		    					...
    	    		    					if($.inArray(2, taskPersonStas) > -1){
   	    		    						...
   	    		    						if($.inArray(1, taskPersonStas) > -1){
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a  class='ZXRW_QX' data-url='<%=basePath%>commens/ywgl/xsgl/excute.htm?id="+d.id+"&routeId="+d.trnId+"' data-title='执行任务'  onclick='kaishirenwu(this)'  href='javascript:void(0);' >执行任务</a>  " ;
    	    		    					}
    									}else if(d.task_sta == 4 ){//完成待审核
   											<%-- 	if($.inArray(1, taskPersonStas) > -1){
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a  class='ZXRW_QX' data-url='<%=basePath%>commens/ywgl/xsgl/excute.htm?id="+d.id+"&routeId="+d.trnId+"' data-title='执行任务' onclick='kaishirenwu(this)'  href='javascript:void(0);' >执行任务</a>";
   											...
   											if($.inArray(3, taskPersonStas) > -1){
    	    		    						...
    	    		    						layerA += "<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a  class='BH_QX layer' data-url='<%=basePath%>commens/ywgl/xsgl/shenhe.htm?id="+d.id+"' data-title='审核' data-width='700px' data-height='300px'  href='javascript:void(0);' >驳回 </a>";
    	    		    					}
    									}else if(d.task_sta == 5 ){//审核通过
    	    		    				}else if(d.task_sta == 6 ){//审核驳回
    	    		    					if($.inArray(1, taskPersonStas) > -1){
...
function  shenhe(id){
	...
	layer.confirm("确定审核通过？",function(){
		$.ajax({
	    	url:url+"updTourTaskStaCheck.htm",
...
function  kaishi(id,tour_route_id){
	...
	layer.confirm("确定开始执行任务？",function(){
		$.ajax({
	    	url:url+"updTourTaskStaExecute.htm",
