...
<div class="pt18" style="height:100%;">
	...
	<div  class="pl8 pr8 pb18 bg-ff">
		<div class="clr wauto" >
		 	 <a  class='layer fr' id="add_btn" style="padding:5px;border:1px solid #ccc;border-radius:3px;background-color: #00b8b7;color:#fff;display:none;" data-url='<%=basePath%>commens/ywgl/xsgl/editRoute.htm?task_id=${id}&routeId=${routeId}' data-title='新增记录' data-width='650px' data-height='300px'   href='javascript:void(0);' >新增记录 </a> 
	     </div>
     </div>
