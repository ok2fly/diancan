...
<div class="pt18">
	...
	<table cellpadding="0"   border="0" width="100%" class="poptable">
		<tr>
			<th>巡视路线</th>
			<td><select class="popinput requiredInp" id="tour_route_id"></select></td>
			<th>执行人</th>
			<td>
				<select class="popinput requiredInp" id="task_execute_id">
		...
		<tr>
			<th>备注</th>
			<td colspan="3">
				<textarea    cols="3"  rows="3" placeholder="请输入备注" id="remark"    class="poptextarea"></textarea>
			</td>
		</tr>
	</table>
