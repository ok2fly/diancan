...
<div class="pt18">
	...
	<table cellpadding="0"   border="0" width="100%" class="poptable">
		<tr>
			<th>驳回原因</th>
			<td colspan="3">
			<textarea    cols="3"  rows="3"   placeholder="请输入驳回原因" id="task_reject_reason"  class="poptextarea"></textarea>
			</td>
			<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
function update(){
	...
	var param =  "id="+id+"&check_use_id="+user_id ;
	if(task_reject_reason != '' && task_reject_reason != undefined){
		param += "&check_remark="+task_reject_reason ;
	}else{
		layer.alert("请输入驳回原因");
		return ;
	}
