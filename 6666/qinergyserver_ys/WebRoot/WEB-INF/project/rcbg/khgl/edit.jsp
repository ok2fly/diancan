...
<div class="pt18">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="poptable">
		<tr>
			...
			<th>部门</th>
			<td><select  id="dep_id" value="0" placeholder="请选择部门"   class="popinput "></select></td>
		</tr>
		<tr>
			<th>职位</th> 
			...
			<tr>
			<th>账号</th>
			<td><input type="text" placeholder="请输入账号"  id="acc_num1"   class="popinput quinputcol requiredInp"  readonly=readonly  autocomplete="off"  oninput="if(value.length>20)value=value.slice(0,20)" ></td>
			<th>姓名</th>
...
function update(){
	...
	if(reFlag){
	 ...
	 param += "&mod_use_id="+mod_use_id+"&com_id="+com_id+"&dep_id="+dep_id+"&pos_id="+pos_id+"&edu_id="+edu_id+"&rol_id="+rol_id+"&use_sta="+use_sta+"&acc_num="+acc_num+
	 			"&use_nam="+use_nam+"&use_mob="+use_mob+"&use_sex="+use_sex+"&use_idc="+use_idc+"&use_mal="+use_mal+
