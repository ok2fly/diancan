...
<div class="pt18">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="poptable">
		...
		<tr>
			<th>账号</th>
			<td><input type="text" placeholder="请输入账号"  id="acc_num1"   class="popinput quinputcol requiredInp" autocomplete="off"></td>
			<th>密码</th>
			<td>
	    		...
	    		if (data.resultcode=="USR000") {
	    			 if(data.data.length > 0 ){
	    				 ...
	    				 for(var i = 0; i< data.data.length ; i++){
	    					 var org = data.data[i];
	    					 if(window.parent.checkComId == org.id){
...
function insert(){
	...
	if(reFlag){
	 ...
	 if(tak_tim==null){
		 param+="#tak_tim="+myDate.toLocaleString(); 
	 }
