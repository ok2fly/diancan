		...
		<div class="w100 fl mt15">
			 <div class="pl15 ml15 mr15">
	            ...
	            <div class="pl8 pr8 mt10 bg-ff  bor-ccc" id="jhhsjfdl" style="display:none;">
	              <div   class="h300"> 
	                 	<h4 class="chart-title">计划与实际充放电量</h4>
		    		...
		    		if (data.resultcode=="USR000") {
		    			 if(data.data.length> 0){
		    				 ...
		    				 for(var i = 0 ; i < data.data.length ; i++){
		    					 ...
		    					 ydata1.push(getFixedNum5(d.plan_phi/1000));
		    					 
		    					 ydata2.push(getFixedNum5(d.plan_phe/1000));
		    					 
		    					 ydata3.push(getFixedNum5(d.pcs_phi/1000));
		    					 
		    					 ydata4.push(getFixedNum5(d.pcs_phe/1000));
