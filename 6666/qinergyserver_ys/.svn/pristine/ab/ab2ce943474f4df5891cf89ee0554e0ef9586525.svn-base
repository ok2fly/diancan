...
<html>
		...
		<div class="w100 fl mt15">
			 <div class="pl15 ml15 mr15">
	              	 ...
	              	 <div class="w90 fl mt15">
                  	   ...
                  	   <div class="tj-query">
                  	   		...
                  	   		<div id="area" class="sz-area">
                  	   			<select class="fl quinput w20"  style="margin-left:22px;"  id="sheng"   onchange="getShi(this.value)"></select> 
	            ...
	            <div class="pl8 pr8 mt10 bg-ff  bor-ccc" id="gzsbs" style="display:none;">
	              <div   class="h300"> 
	                 	<h4 class="chart-title">储能收益</h4>
	                  	 <div class="h250 w100 fl"   id="cnsy-chart"></div>
	              </div>
	            </div>
	             <div class="mb50"></div>
			 </div>
						...
						for (var i = 0; i < data.data.length; i++) {
							...
							for (var cc = 0; cc < lst.saInfLst.length; cc++) {
								...
								if ($.inArray("type1", checkType) > -1) {
									gzsbsYData.push(getIsNull(o.ene_stg_rvn));
								} 
							}
	...
	function gzsbsSetChart() {
		var myChart = echarts.init(document.getElementById('cnsy-chart'),
				'shine');
		var option = {
			tooltip : {
				trigger : 'axis',
