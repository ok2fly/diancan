...
<div class="pt18">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="poptable">
		<tr>
			<th>安全类型</th> 
			<td><select class="popinput requiredInp"   placeholder="请选择安全类型" name="typeId" id="typeId" ></select></td>
			<th>名称</th>
			<td><input type="text" placeholder="请输入名称" name="sctName" id="sctName" class="popinput quinputcol requiredInp"></td>
		</tr>
		<tr>
			<th>描述</th>
			<td colspan="3">
