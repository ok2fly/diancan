...
$(function(){
  ...
  getCompLog();   // 获取和设置 logo 图片 和 系统名字

  showLocale();   // 显示日期和时间 年月日时分秒
...
function loadTime(){
  ...
  getUseData();  // 获取用户公司数据   为地图标注点 准备数据

  getDzData();   // 综合数据和社会贡献  数据显示

  getYwData();   // 电量统计 和 电量趋势 数据显示
