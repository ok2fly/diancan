 ...
 * @date: 2017年11月28日
 */
public class TrainingManagerDto implements Serializable{

	private static final long serialVersionUID = 3385250119921149133L;
	
	public static final int DEL_FLAG_NO = 0; //未删除：显示
	public static final int DEL_FLAG_YES = 1; //
	
	/**  0:未开始 1:进行中 2:已结束*/
	public static final int TRA_STA_NOT_BEGIN = 0; //0:未开始 （）
	public static final int TRA_STA_STARTING = 1; //进行中
	public static final int TRA_STA_FINISH = 2; //:已结束
	...
	private Integer tra_sta; // 培训状态（0:未开始 1:进行中 2:已结束）
	...
	public Integer getTra_sta() {
		return tra_sta;
	}
	public void setTra_sta(Integer tra_sta) {
		this.tra_sta = tra_sta;
	}
