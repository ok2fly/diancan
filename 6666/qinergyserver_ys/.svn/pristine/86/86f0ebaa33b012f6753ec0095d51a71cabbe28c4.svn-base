		...
		<div class="w100 h670">
			<div class="bg-ff pl15 pt10 clr pl8">
				<div class="query">
					...
					<div class="fr mr15">
						<a  class="queryicon layer XZJH_QX"  data-url="<%=basePath%>/commens/jhgl/cfdljh/add.htm" data-title="新增充放电量计划"  ><i class="add"></i>新增计划</a>
					</div>
				</div>
			</div>
				...
				if(data.resultcode=="USR000"){
					...
					if(data.data.length > 0 ){
						...
						for(var i=0;i<data.data.length;i++){
							...
							"<td>"+getFixedNum5(d.plan_phi)+"</td>"+
							"<td>"+getFixedNum5(d.plan_phe)+"</td>"+
							...
							"<td><a  href='javascript:void(0);' class='SCJH_QX'  onclick='del("+d.id+")'>删除</a>"+
			              	"<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a class='layer XGJH_QX'  data-url='<%=basePath%>commens/jhgl/cfdljh/edit.htm?id="+d.id+"' data-title='修改'   href='javascript:void(0);' >修改 </a>"+
			              	"</tr>";
						}
