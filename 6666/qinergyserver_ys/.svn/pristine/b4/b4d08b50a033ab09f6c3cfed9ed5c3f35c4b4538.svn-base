...
<script type="text/javascript">
	$(function (){
		...
		$.ajax({
			url:url+"getIscsAcchpStdAndRelByEquNumNew.htm",
				...
				if(data.resultcode=="USR000"){
					...
					var healthStat = d.healthStat == 1 ? "优秀" : d.healthStat == 2 ? "良好":d.healthStat == 3 ? "中等":d.healthStat == 4 ? "差":"--" ; 
					 ...
					 if(data.data.relLst.length>0){
						...
						$("#ua2").html(getFixedNum5(a.ua));
						$("#ub2").html(getFixedNum5(a.ub));
						$("#uc2").html(getFixedNum5(a.uc));
						$("#ia2").html(getFixedNum5(a.ia));
						$("#ib2").html(getFixedNum5(a.ib));
						$("#ic2").html(getFixedNum5(a.ic));
						$("#power2").html(getFixedNum5(a.power));
						$("#currPower").html(getFixedNum5(a.currPower));
						$("#money2").html(getFixedNum5(a.money));
						$("#tolPower2").html(getFixedNum5(a.tolPower));
